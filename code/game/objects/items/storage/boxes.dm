...
/obj/item/storage/box/cookie/PopulateContents()
	...
	new /obj/item/reagent_containers/food/snacks/oatmealcookie(src)
	new /obj/item/reagent_containers/food/snacks/raisincookie(src)
	new /obj/item/reagent_containers/food/snacks/raisincookie(src)
...
/obj/item/storage/box/smartmetalfoam
	name = "box of smart metal foam grenades"
	desc = "To be used to rapidly seal hull breaches"
	icon_state = "flashbang"

/obj/item/storage/box/smartmetalfoam/New()
	..()
	for(var/i in 1 to 7)
		new /obj/item/grenade/chem_grenade/smartmetalfoam(src)
