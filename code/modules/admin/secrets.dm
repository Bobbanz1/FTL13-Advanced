/datum/admins/proc/Secrets()
	...
	if(check_rights(R_ADMIN,0))
		dat += {"
			...
			<A href='?src=\ref[src];[HrefToken()];secrets=set_name'>Rename Ship Name</A><BR>
			<A href='?src=\ref[src];[HrefToken()];secrets=reset_name'>Reset Ship Name</A><BR>
			<BR>
			<B>Shuttles</B><BR>
			<BR>
	...
	if(check_rights(R_FUN,0))
		dat += {"
			...
			<A href='?src=\ref[src];[HrefToken()];secrets=eagles'>Egalitarian Ship Mode</A><BR>
