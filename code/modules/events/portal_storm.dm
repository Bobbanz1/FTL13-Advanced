...
/datum/round_event/portal_storm/announce()
	set waitfor = 0
	sound_to_playing_players('sound/magic/lightning_chargeup.ogg', repeat=0, channel=1, volume=100)
	sleep(80)
	priority_announce("Massive bluespace anomaly detected en route to [station_name()]. Brace for impact.")
	sleep(20)
	sound_to_playing_players('sound/magic/lightningbolt.ogg', repeat=0, channel=1, volume=100)
